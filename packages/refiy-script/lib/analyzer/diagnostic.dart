...
class RSDiagnostic {
  ...
  final RSDiagnosticMessage problemMessage;

  /// The severity associated with the diagnostic.
  final ErrorSeverity severity;

  RSDiagnostic(this.contextMessages, this.correctionMessage,
      this.problemMessage, this.severity);
}

/// A single message associated with a [RSDiagnostic], consisting of the text of
/// the message and the location associated with it.
///
/// Clients may not extend, implement or mix-in this class.
class RSDiagnosticMessage {
  ...
  RSDiagnosticMessage(this.filename, this.offset, this.length, this.message);
}
